...
shinyUI(navbarPage("Bio-Profiler",
                   ...
                   tabPanel("Photographic reference",
                            h5("Please provide photo reference numbers or filepaths any of the following that were used in profile creation. Multiple entries should be separated with a /"),
                            column(width=4,h3("Age"),
                                   textInput("Epi_P","Epiphyses",value=NA),
                                   textInput("PS_P","Pubic Synthesis",value=NA),
                                   textInput("Aur_P","Auricular surface",value=NA),
                                   textInput("Rib_P","4th Rib",value=NA),
                                   textInput("Suture_P","Suture closure",value=NA)),
                            column(width=4,h3("Sex"),
                                   textInput("Pubic_P","Pubic bone",value=NA),
                                   textInput("GSN_P","Greater sciatic notch",value=NA),
                                   textInput("Pelvis_P","Articulated pelvis",value=NA),
                                   textInput("OsC_P","Other Os coxa",value=NA),
                                   textInput("Mastoid_P","Mastoid process",value=NA),
                                   textInput("SO_P","Supra-orbital region",value=NA),
                                   textInput("NC_P","Nuchal crest",value=NA),
                                   textInput("Man_P","Mandible",value=NA)),
                            column(width=4,h3("Ancestry"),
                                   textInput("Vault_P","Cranial vault",value=NA),
                                   textInput("Orbit_P","Orbits",value=NA),
                                   textInput("Nasal_P","Nasal cavity",value=NA),
                                   textInput("AntC_P","Anterior Cranial",value=NA),
                                   textInput("LatC_P","Lateral Cranial",value=NA))
                            ),
