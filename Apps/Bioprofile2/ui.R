                              ...
                              conditionalPanel("input.knownsex=='unknown'",
                                               fluidRow(
                                                 column(width=3,
                                                        ...
                                                        selectInput("pSize","Pelvis Size",c("Undeterminable"=NA,"Large and Rugged"="m","Small and Gracile"="f","Intermediate"="u")),
                                                        selectInput("iShape","Illium Shape",c("Undeterminable"=NA,"High and Vertical"="m","Low and Flat"="f","Intermediate"="u")),
                                                        selectInput("pInlet","Shape of pelvic inlet",c("Undeterminable"=NA,"Heart shaped"="m","Circular or Ellipitical"="f","Intermediate"="u")),
                                                        selectInput("pShape","Pubic Shape",c("Undeterminable"=NA,"Narrow and Rectangular"="m","Broad and Square"="f","Intermediate"="u")),
                                                        selectInput("spAngle","Subpubic angle",c("Undeterminable"=NA,"V-shaped"="m","U-Shaped"="f","Intermediate"="u")),
                                                        selectInput("OF","Obturator foramen",c("Undeterminable"=NA,"Large and Ovoid"="m","Small and Triangular"="f","Intermediate"="u")),
                                                        selectInput("sShape","Sacrum Shape",c("Undeterminable"=NA,"Long and Narrow"="m","Short and Broad"="f","Intermediate"="u")),
                                                        br(),
                                                        br(),
                                                        br(),
                                                        br()
                                                 ...
                                                 column(width=3,
                                                        ...
                                                        selectInput("Chin","Chin Shape (view from below)",c("Undeterminable"=NA,"Broad"="m","Pointed"="f","Intermediate"="u")),
                                                        selectInput("cSize","Skull Size",c("Undeterminable"=NA,"Large and Rugged"="m","Small and Gracile"="f","Intermediate"="u")),
                                                        ...
                                                        selectInput("gAngle","Gonial Angle",c("Undeterminable"=NA,"Close to 90 degrees"="m","Obtuse(~110-120)"="f","Intermediate"="u"))
                                                 ),
                                                 column(width=3,
