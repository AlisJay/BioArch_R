...
V_CS_UI<-tagList(h3("ID:V_CS"),h4("Description:Custom Shape Abnormality"),
                 ...
                 column(width=4,
                        ...
                        conditionalPanel("input.V_CS_Type=='Bowing'",
                                         ...
                                         conditionalPanel("input.V_CS_Bowing3",selectInput("V_CS_Bowing3b","Extent of fusion",c("Single small/narrow bony connection across the joint"="single small","2-3 small separate connections"="2-3 small",">3 small connections"=">3 small","Single large connection (not covering entire the joint)"="single large","Multiple large connections"="Multiple large","Multiple connections of various sizes"="Multiple various","Complete fusion/ very little or no gaps"="Complete")))),
