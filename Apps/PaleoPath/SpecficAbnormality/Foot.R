...
F_S05_UI<-tagList(fixedPage(h3("ID:F_S05"),
                            ...
                            column(width=4,h4("Connection with other lesions"),
                                   textInput("F_S05_Link1","ID of linked lesion(s)",value="None"),
                                   selectizeInput("F_S05_Link2","Connection type",multiple=TRUE,choice=c("Continuation","Symetrical","Overlapping","Similar appearance","Potential systemic condition","Shared joint","Additional description")))))
F_S05_RC<-function(input=input){   
  ...
  if(input$F_S05_Link1 != "None"){Table$Link<-paste(paste(input$F_S05_Link1,collapse=","),paste(input$F_S05_Link2,collapse=","),sep=":")}
  Table }
...
Foot_DT<-data.table(ref=c("F_S01","F_S02","F_S03","F_S04","F_S05","F_S06","F_S07","F_L01","F_L02","F_L03","F_L04","F_F01","F_F02","F_F03","F_C01","F_C02"),
                    ...
                    RecordCreator=c(F_S01_RC,F_S02_RC,F_S03_RC,F_S04_RC,F_S05_RC,F_S06_RC,F_S07_RC,F_L01_RC,F_L02_RC,F_L03_RC,F_L04_RC,F_F01_RC,F_F02_RC,F_F03_RC,F_C01_RC,F_C02_RC))